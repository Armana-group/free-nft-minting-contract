import { System, SafeMath, Protobuf, Arrays, authority, error, StringBytes, Crypto, value } from "@koinos/sdk-as";
...
export class Collections {
  ...
  token_uri(args: collections.token_uri_arguments): collections.string_object {
